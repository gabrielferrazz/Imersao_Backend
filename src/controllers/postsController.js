...
export async function listarPosts(req, res) {
    try {
        ...
        // Atualiza os URLs das imagens para usar a URL pública do .env
        const updatedPosts = posts.map(post => ({
            ...post,
            imagemUrl: post.imagemUrl.replace("http://localhost:3000", baseUrl),
        }));
...
export async function uploadImagem(req, res) {
    ...
    try {
        ...
        // Atualiza o post com a URL pública da imagem
        const updatedPost = {
